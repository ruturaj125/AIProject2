...
def forward_selection():
	...
	for i in range(1, num_cols):
		print("On the " + str(i) + " level of search tree")
		...
		for j in range(1, num_cols):
			...
			if j not in curr_set_features:
				print("->Considering the " + str(j) + " feature")
...
def backward_elimination():
	...
	for i in range(1, num_cols):
		...
		more_features.append(y)
		maxpos = good_accuracies.index(max(good_accuracies))
		print("On level " + str(i) + " I removed feature " + str(feature_to_sub_at_level) + " from the current set\n")
